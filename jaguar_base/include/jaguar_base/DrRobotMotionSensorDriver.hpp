  ...
  class DrRobotMotionSensorDriver {
    public:
      ...
      */
      ...
      /*! @brief
      *  If the driver is configured as using network communication, this function could open UDP port to connect with robot and start communication
    ...
    private:
      ...
      int valid_ip(const char* ip_str);
      int sendAck();
